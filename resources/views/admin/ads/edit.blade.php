    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.ads.update", [$ad->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="image">{{ trans('cruds.ad.fields.image') }}</label>
            ...
            <div class="form-group">
                <label for="url">{{ trans('cruds.ad.fields.url') }}</label>
                <input class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" type="text" name="url" id="url" value="{{ old('url', $ad->url) }}">
                @if($errors->has('url'))
