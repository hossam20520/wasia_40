                ...
                <tbody>
                    @foreach($categories as $key => $category)
                        <tr data-entry-id="{{ $category->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $category->isparent ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $category->isparent ? 'checked' : '' }}>
                            </td>
                            <td>
                                <span style="display:none">{{ $category->ischild ?? '' }}</span>
                            ...
                            <td>
                                {{ $category->parent_category->label ?? '' }}
                            </td>
                            {{-- <td>
                                <span style="display:none">{{ $category->parent_category->isparent ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $category->parent_category->isparent ? 'checked' : '' }}>
                            </td>
                            <td>
                                <span style="display:none">{{ $category->parent_category->ischild ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $category->parent_category->ischild ? 'checked' : '' }}>
                            </td> --}}
                            <td>
                                @can('category_show')
