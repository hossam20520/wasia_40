        ...
        <form method="POST" action="{{ route("admin.categories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('isparent') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="isparent" id="isparent" value="1" {{ old('isparent', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('ischild') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="ischild" id="ischild" value="1" {{ old('ischild', 0) == 1 ? 'checked' : '' }}>
