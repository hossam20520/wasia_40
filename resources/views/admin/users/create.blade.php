        ...
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('block') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="block" id="block" value="1" {{ old('block', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('delete') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="delete" id="delete" value="1" {{ old('delete', 0) == 1 ? 'checked' : '' }}>
