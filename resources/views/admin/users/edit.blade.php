        ...
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('block') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="block" id="block" value="1" {{ $user->block || old('block', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('delete') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="delete" id="delete" value="1" {{ $user->delete || old('delete', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="delete">{{ trans('cruds.user.fields.delete') }}</label>
                </div>
                @if($errors->has('delete'))
                    <span class="text-danger">{{ $errors->first('delete') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.delete_helper') }}</span>
            </div>
            <div class="form-group">
