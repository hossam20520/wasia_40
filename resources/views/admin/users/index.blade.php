            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.user.fields.delete') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($users as $key => $user)
                        <tr data-entry-id="{{ $user->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $user->block ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $user->block ? 'checked' : '' }}>
                            </td>
                            <td>
                                <span style="display:none">{{ $user->delete ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $user->delete ? 'checked' : '' }}>
                            </td>
                            <td>
                                @can('user_show')
